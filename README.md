...
This file is usually generated by `init.wimbly` and usually contains an include lines with a wildcards to instruct nginx to include endpoint definition files inside the application source code.
